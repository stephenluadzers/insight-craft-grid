/**
 * LEGAL DISCLAIMER:
 * This software analyzes publicly available data from images, photos, and visual content 
 * strictly for educational, analytical, and productivity purposes. It does not download, 
 * store, or redistribute any copyrighted visual content beyond the analysis session.
 * 
 * The system extracts and transforms visual information (workflow structures, diagrams, 
 * process flows, and metadata) to generate workflow diagrams and summaries.
 * 
 * This process is a transformative use under Section 107 of the U.S. Copyright Act, as no 
 * unauthorized reproduction, monetization, or rehosting of the source material occurs.
 * 
 * All intellectual property rights in the original images remain with their respective creators. 
...
IMPORTANT: Always include this disclaimer at the end of your "insights" field or as a separate "disclaimer" field:

"DISCLAIMER: This workflow was generated by analyzing visual content for educational and productivity purposes. No copyrighted visual content was stored or redistributed beyond this analysis. This is a transformative use under U.S. Copyright Act Section 107. All intellectual property rights remain with original creators. Users must ensure compliance with local laws and platform policies."`
            },
            {
              role: 'user',
              content: userContent
