...
IMPORTANT: Always include this disclaimer at the end of your response in the "explanation" field or as a separate "disclaimer" field:

"DISCLAIMER: This workflow was generated by analyzing publicly available metadata for educational and productivity purposes. No video, audio, or copyrighted content was downloaded or redistributed. This is a transformative use under U.S. Copyright Act Section 107. All intellectual property rights remain with original creators. Users must ensure compliance with local laws and platform policies."`
          },
          {
            role: 'user',
            content: description
